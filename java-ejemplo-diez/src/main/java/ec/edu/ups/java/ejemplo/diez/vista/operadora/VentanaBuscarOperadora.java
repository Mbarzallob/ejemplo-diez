...
public class VentanaBuscarOperadora extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtCodigo.setToolTipText("Ingrese el codigo de la operadora a buscar");
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (operadorita != null) {
            ...
            JOptionPane.showMessageDialog(this, "La operadora con el codigo " + codigo + " no ha sido encontrada!");
        }
